            ...
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <a href="javascript:history.back()" class="btn btn-link text-decoration-none me-2 p-0" title="Volver">
                            &larr;
                        </a>
                        <h3 class="mb-0">Registrar Nueva Mascota</h3>
                    </div>
                    <div>
                        <a href="<?= Controller::path() ?>mascota" class="btn btn-outline-secondary btn-sm">Ver Mascotas</a>
                        <a href="<?= Controller::path() ?>usuario/panel" class="btn btn-outline-primary btn-sm">Panel</a>
                    </div>
                </div>
                <div class="card-body">
